...
class BoTSORT(object):
    ...
    def update(self, output_results, img):
        ...
        for track in self.lost_stracks:
            if self.frame_id - track.end_frame > self.max_time_lost:
                track.mark_removed()
                self.tracks_to_count.append(track)
                removed_stracks.append(track)
    ...
    def get_tracks_to_count(self):
        if len(self.tracks_to_count):
            tracks_to_count = self.tracks_to_count
            self.tracks_to_count = []
            return tracks_to_count
